...
if __name__ == "__main__":
    folder = "/afs/crc.nd.edu/user/y/ypeng4/data/raw_data/Dataset002_Iowa"
    out_folder = "/afs/crc.nd.edu/user/y/ypeng4/data/raw_data/Dataset002_Iowa"
    ...
    current_dir = join(folder, "masks")
    segmentations = subfiles(current_dir, suffix=".nii.gz")

    raw_data = subfiles(join(folder, "images"), suffix=".nii.gz")
    ...
    for i in segmentations:
        out_fname = join(out_folder, "labelsTr", i.split("/")[-1][:-12] + ".nii.gz")
